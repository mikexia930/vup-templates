...
- 先阅读目标模块现有 views/components/api/stores/types/locales 或 Nest module/controller/service/dto。
...
- 改 Nest：同步 module imports/providers/controllers、entity、migration、seed、测试。
