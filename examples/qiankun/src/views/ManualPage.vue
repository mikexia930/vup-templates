...
<template>
  <main class="from-neutral-1 to-primary-0 min-h-[420px] bg-linear-to-b p-[24px]">
    <section class="border-neutral-3 rounded-md border bg-white p-[22px] shadow-sm">
      <p class="text-primary-6 text-sm font-bold">Manual child route</p>
      <h1 class="leading-sm text-neutral-9 mt-[6px] text-[28px] font-extrabold">手动加载子页面</h1>
